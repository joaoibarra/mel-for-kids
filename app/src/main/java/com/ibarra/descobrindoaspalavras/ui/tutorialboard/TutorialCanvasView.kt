...
private const val STROKE_PPOLYGON_WIDTH = 30f

class TutorialCanvasView@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : View(context, attrs, defStyle) {
